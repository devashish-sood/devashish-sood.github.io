    ...
    <div>
      ...
      <ol className="list-decimal ml-6 mt-2 space-y-2">
        ...
        <li className="pl-2">
          ...
          predicts a customer’s lifetime value. Clients use this tool to isolate
          and improve areas of significant churn.
        </li>
      </ol>
      <br />I also worked on several other projects -
...
},
{
  ...
  description: (
    <div>
      <p>RBAC Pulsar Streaming - I engineered a role-based access control architecture for stream data from the data platform using Apache Pulsar. This allowed international teams to safely interact with Toast's data.</p>
      <br />Other work -
      <ul className="list-disc ml-6 mt-2 space-y-2">
        ...
        <li className="pl-2">
          Created a automated validation pipeline for SQL views provided to the data platform by other teams.
        </li>
      </ul>
    </div>
  )
...
const Experiences = () => {
  return (
    EXP_ARR.map((p) => SingleExp({props: p}))
  );
};
