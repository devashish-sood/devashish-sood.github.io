...
const Home = () => {
  ...
  <p>
   ...
   <img src="/mountains.jpg" alt="Mountains" style={{ width: '40%' }}/>
    <div className="pl-10">Currently, I'm: 
   <ul className="list-disc pl-4">
    <li className="my-2">writing an operating system in Rust.</li>
    <li className="my-2">implementing the Raft consensus protocol for distributed systems.</li>
    <li className="my-2">reading <Link href="https://papl.cs.brown.edu/2020/" text="PAPL"/> to write my own interpreter and compiler.</li>
    <li className="my-2">attempting to become a functional bro by learning some OCaml.</li>
    <li className="my-2">optimizing my burnt basque cheesecake recipe.</li>
   </ul>
   </div>
   </div>
   <br/>
